...
public:
    explicit GShaderParser(std::string_view g_shader_source, const std::filesystem::path &source_path,
...
Ref<Resource> GShaderLoader::load(std::string_view type, const std::filesystem::path &base_dir, std::string_view name,
    ...
    GShaderParser parser(g_shader_source, parent_path, resources.get_root_dir());
