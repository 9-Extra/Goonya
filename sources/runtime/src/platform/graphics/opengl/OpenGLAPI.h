...
public:
    ...
    // --------------------其他------------------------------
    Matrix4f compute_perspective_matrix(float ratio, float fov, float near_z, float far_z) const noexcept;
    Matrix4f compute_orthographic_matrix(float ratio, float scale, float near_z, float far_z) const noexcept;
