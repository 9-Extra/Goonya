...
intrusive_ptr<GLPipelineStateObject> PSOCache::load_pso(const Resource::PSODesc &desc) {
    intrusive_ptr<GLPipelineStateObject> container{new GLPipelineStateObject()};
    ...
    container->shader = shader_lib.query_shader(desc.shader_desc);
